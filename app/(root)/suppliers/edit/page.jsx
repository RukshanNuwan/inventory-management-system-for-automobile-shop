...
const page = () => {
  ...
  const onFormSubmit = async (data) => {
    ...
    try {
      const response = await updateSupplier(data, selectedItem.id);
    ...
    <section>
      ...
      <main className="no-scrollbar flex w-full p-2">
        <div className="w-full h-full">
          <div className="py-4">
            <h1 className="font-bold text-3xl">Edit Supplier Details</h1>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-muted-foreground">
                    Please fill the form to update the Supplier
                  </CardTitle>
                </CardHeader>
